...
describe('JVM Live Thread Dashboard Automation', () =>{

    const apiURL = "https://prometheus.axp.com/api/v1/query?query=sum(jvm_threads_daemon{job=~'.*'})";
    ...
    beforeEach(() =>{
        cy.request({
            ...
            cy.wrap(threadRes).as('apiResponse')
        })
    })
